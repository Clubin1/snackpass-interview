let text = {
   ...
   useEffect: `   // Run fetchData() on component load 
   useEffect(() => {
   ...
   infiniteScroll: `    // Helper variables used to hold first 10 items displayed and the number of items that will be added on each 
   // state update
   let numToAdd = 10;
   // Orders get request
   const onScroll = () => {
   ...
   setup: `   // State we are using to display items
   ...
   // state update
   let numToAdd = 10;`,
   total: ` import { React, useState, useEffect, useRef } from 'react';
